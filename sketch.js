...
function setup() {
 ...
 backGround.addImage(backgroundImg);
  backGround.scale = 2.7;
    ...
    edge = createSprite(900,200,10,600);
  edge.visible=false;
  ...
  unicorn = createSprite (850,320,50,50);
  unicorn.X = 850;
  ...
  ground = createSprite(200,380,1800,10);
...
if (keyWentUp("left_arrow")){
  ...
  textSize(15);
  fill("black");
  text ("Press Left Arrow:"  , 840 ,20 );
  
  stroke("black");
  textSize(15);
  fill("black");
  text ("To surpass Obstacles"  , 840 ,34 );
